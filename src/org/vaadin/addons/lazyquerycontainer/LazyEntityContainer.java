...
/**
 * Fork di LazyEntityContainer per rimuovere le limitazioni
 * final dalla classe e poterla estendere.
 * Solo il codice legato a final è stato modificato.
 * In occasione di una nuova release dovrebbe essere safe
 * ricopiare i sorgenti e rifare il fork.
 * Alex 9-1-2016
 * -----------
 ...
 */
public class LazyEntityContainer<T> extends LazyQueryContainer {
    /**
