...
public class ATable extends Table {
	...
	protected Container createContainer() {
		JPAContainer cont = JPAContainerFactory.makeNonCached(getEntityClass(),
				EM.createEntityManager());
//		JPAContainer cont = JPAContainerFactory.make(getEntityClass(),
//				EM.createEntityManager());
	 ...
	 * @param useTotals
	 *            - to add or remove the column from the list
	 * @param decimalPlaces
	 *            - the number of decimal places, -1 for autodetect
	 */
	...
	/**
	 * @return a new BeanItem for a given row
	 * @param rowId
	 *            the row id
